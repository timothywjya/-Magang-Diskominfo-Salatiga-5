                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="dinas_id" id="dinas_id">
                            ...
                            <option value="{{$datas->id}}">{{$datas->nama_dinas}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('gmail') is-invalid @enderror" id="exampleInputgmail" placeholder="Masukkan Gmail" name="gmail" value="{{old('gmail')}}">
